 ...
 *
 * Author:   Ayaz Franz (acfranz@wisc.edu)
 * Date:     March 6, 2020
 *
 * Course:   CS400
...
public class HashTable<K extends Comparable<K>, V> implements HashTableADT<K, V> {
	...
	/**
	 * Private inner class for LinkedNode objects. LinkedNode objects hold key value
	 * pairs and can be linked.
	 * 
	 * @author acfranz
	 *
	 */
	private class LinkedNode {
		...
		/**
		 * Constructor for LinkedNode objects setting their key and value fields
		 * appropriately and leaving next to be null
		 * 
	 ...
	 * loadFactorThreshold to 1.5, and initializes all values in data to null.
	 */
	public HashTable() {
	...
	/**
	 * Constructor for HashTable object that takes user inputs. Sets the
	 * loadFactorThreshold and capacity accordingly and initializes the all values
	 * in data to null.
	 * 
	...
	/**
	 * Removes a key value pair from the HashTable. If the key was not in the
	 * HashTable, method returns false.
	 * 
